...
class KeyChain:NSObject{
    ...
    :param: serviceIdentifier oznaka servica pod kojeg zelimo spremiti token.
    :param: token podatci koje zelimo spremiti.
    */
    ...
    :param: serviceIdentifier ime tokena kojeg želimo dohvatit.
