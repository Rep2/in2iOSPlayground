...
class ALNetwork{
    ...
    /// :params: operation  operacija koja je predana preko http poziva.
    /// :params: response Odgovor na HTTP poziv.
    ...
    :params: operation operacija za zahtjev.
    :params: error greska koja opisuje razlog neuspjeha.
    */
